...
public class Janela extends JFrame implements ActionListener {
    ...
    private ImageIcon imgPizza1;
    private ImageIcon imgPizza2;
    private ImageIcon imgPizza3;
    ...
    public Janela() {
        ...
        imgPizza1 = new ImageIcon("./src/imagens/pizza1.png");
        imgPizza2 = new ImageIcon("./src/imagens/pizza2.png");
        imgPizza3 = new ImageIcon("./src/imagens/pizza3.png");
    ...
    public void actionPerformed(ActionEvent dispara) {
        if (dispara.getSource() == this.btnCorrida) {
            this.lblPista.add(JLabelCarros("Chicaco Syle", imgPizza1, 0, 50));
            this.lblPista.add(JLabelCarros("Nonna Style", imgPizza2, 0, 200));
            this.lblPista.add(JLabelCarros("NYC Style", imgPizza3, 0, 350));
        }
